...
var data = {
	"rules": {
		"Algeria": [
			...
			"1921,1921,5,21,1380s,0,-",
			"1939,1939,8,11,1380s,60,S",
			"1939,1939,10,19,60,0,-",
			"1944,1945,3,1:1,120,60,S",
			"1944,1944,9,8,120,0,-",
			"1945,1945,8,16,60,0,-",
			"1971,1971,3,25,1380s,60,S",
			"1971,1971,8,26,1380s,0,-",
		...
		"Egypt": [
			...
			"1995,2010,3,-5,0s,60,S",
			"1995,2005,8,-4,1380s,0,-",
			"2006,2006,8,21,1380s,0,-",
			"2007,2007,8,4:1,1380s,0,-",
			"2008,2008,7,-4,1380s,0,-",
			"2009,2009,7,20,1380s,0,-",
			"2010,2010,7,11,0,0,-",
			"2010,2010,8,10,0,60,S",
			"2010,2010,8,-4,1380s,0,-"
		],
		"Ghana": [
		...
		"Libya": [
			...
			"1987,1989,9,1,0,0,-",
			"1997,1997,3,4,0,60,S",
			"1997,1997,9,4,0,0,-",
			"2013,9999,2,-5,60,60,S",
			"2013,9999,9,-5,120,0,-"
		],
		"Mauritius": [
		...
		"Morocco": [
			...
			"2011,2011,6,31,0,0,-",
			"2012,2019,3,0,120,60,S",
			"2012,9999,8,0,180,0,-",
			"2012,2012,6,20,180,0,-",
			"2012,2012,7,20,120,60,S",
			"2013,2013,6,9,180,0,-",
			"2013,2013,7,8,120,60,S",
			"2014,2014,5,29,180,0,-",
			"2014,2014,6,29,120,60,S",
			"2015,2015,5,18,180,0,-",
			"2015,2015,6,18,120,60,S",
			"2016,2016,5,7,180,0,-",
			"2016,2016,6,7,120,60,S",
			"2017,2017,4,27,180,0,-",
			"2017,2017,5,26,120,60,S",
			"2018,2018,4,16,180,0,-",
			"2018,2018,5,15,120,60,S",
			"2019,2019,4,6,180,0,-",
			"2019,2019,5,5,120,60,S",
			"2020,2020,4,24,120,60,S",
			"2021,2021,4,13,120,60,S",
			"2022,2022,4,3,120,60,S",
			"2023,9999,3,0,120,60,S"
		],
		"Namibia": [
		...
		"Tunisia": [
			...
			"1944,1944,9,8,0,0,-",
			"1945,1945,8,16,0,0,-",
			"1977,1977,3,30,0s,60,S",
			"1977,1977,8,24,0s,0,-",
			"1978,1978,4,1,0s,60,S",
			"1978,1978,9,1,0s,0,-",
			"1988,1988,5,1,0s,60,S",
			"1988,1990,8,0,0s,0,-",
			"1989,1989,2,26,0s,60,S",
			"1990,1990,4,1,0s,60,S",
			"2005,2005,4,1,0s,60,S",
			"2005,2005,8,30,60s,0,-",
			"2006,2008,2,0,120s,60,S",
			"2006,2008,9,0,120s,0,-"
		]
	},
	"zones": {
		"Africa/Algiers": [
